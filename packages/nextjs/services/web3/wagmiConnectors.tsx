...
const { onlyLocalBurnerWallet } = AquoConfig;
...
export const appChains = configureChains(
  ...
  [
    alchemyProvider({
      apiKey: AquoConfig.alchemyApiKey,
    }),
    publicProvider(),
  ],
  {
    ...
    ...(targetNetworks.find(network => network.id !== chains.hardhat.id)
      ? {
          pollingInterval: AquoConfig.pollingInterval,
        }
      : {}),
  },
);

const walletsOptions = { chains: appChains.chains, projectId: AquoConfig.walletConnectProjectId };
const wallets = [
